export const cpuData=[
    ...
    {img:"https://www.amd.com/system/files/2018-11/10788-ryzen-chip-left-angle-960x548.png",name:'Ryzen 5 PRO', model:'4650G', type:'Oem', core:'6',socket:"AM4", price:'800', id:12315,inCart: false},
    {img:"https://www.amd.com/system/files/2018-11/10788-ryzen-chip-left-angle-960x548.png",name:'Ryzen 5', model:'5600', type:'Oem', core:'6',socket:"AM4", price:'1100', id:12316,inCart: false},
    ...
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700', type:'Box', core:'8',socket:"LGA1200", price:'800', id:23311},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700F', type:'Oem', core:'8',socket:"LGA1200", price:'800', id:23312},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700F', type:'Box', core:'8',socket:"LGA1200", price:'800', id:23313},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700K', type:'Oem', core:'8',socket:"LGA1200", price:'800', id:23314},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700K', type:'Box', core:'8',socket:"LGA1200", price:'800', id:23315},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700KF', type:'Box', core:'8',socket:"LGA1200", price:'800', id:23316},
    {img:"https://shop.by/images/intel_core_i7_10700k_1.jpg",name:'Intel Core', model:'i7-10700KA', type:'Box', core:'8',socket:"LGA1200", price:'800', id:23317},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900', type:'Oem', core:'10',socket:"LGA1200", price:'800', id:23318},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900', type:'Box', core:'10',socket:"LGA1200", price:'800', id:23319},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900F', type:'Oem', core:'10',socket:"LGA1200", price:'800', id:24311},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900F', type:'Box', core:'10',socket:"LGA1200", price:'800', id:24312},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900K', type:'Box', core:'10',socket:"LGA1200", price:'800', id:24313},
    {img:"https://content2.onliner.by/catalog/device/main/893f1a523d2ba5d67d472f57500f6c25.jpeg",name:'Intel Core', model:'i9-10900KF', type:'Box', core:'10',socket:"LGA1200", price:'800', id:24314},
    {img:"https://upload.wikimedia.org/wikipedia/commons/0/06/Intel_Core_i9_Logo_2020.png",name:'Intel Core', model:'i9-11900KF', type:'Box', core:'10',socket:"LGA1200", price:'800', id:24315},
    {img:"https://en.wikichip.org/w/images/d/d1/core_i9x_logo.png",name:'Intel Core', model:'i9-10920X', type:'Box', core:'10', socket:"LGA2066", price:'800', id:24316},
]